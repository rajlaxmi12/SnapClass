...
try:
    ...
    face_recognition_models = None  # type: ignore
    _FaceRecognitionModelsAvailable = False
...
try:
    ...
    print(f"dlib import failed: {e}")  # terminal mein actual error dikhega
    dlib = None
    _DlibAvailable = False


@st.cache_resource
def load_dlib_models():
    if not _DlibAvailable:
        raise ModuleNotFoundError(
            "Optional dependency 'dlib' is not installed. "
            "Face recognition features are unavailable."
        )
